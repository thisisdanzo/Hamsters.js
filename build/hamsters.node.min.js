	    ...
	    */
	    ...
	    value: function scheduleTask(task, resolve, reject) {
	      return this.pool.scheduleTask(task, this).then(function (results) {
	        ...
	        _logger2.default.error(error.message, reject);
	      });
	    }
	    ...
	    */
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        return _this.scheduleTask(task);
	      });
	    }
	  ...
	  _createClass(pool, [{
	    ...
	    value: function scheduleTask(task, scope) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        while (i < task.threads) {
	          _this.hamsterWheel(i, task, scope);
	          i += 1;
	        }
	      });
	    }
	    ...
	    */
	    ...
	    value: function scheduleTask(task) {
	      this.scheduleTask(task, this).then(function (results) {
