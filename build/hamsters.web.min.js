	  ...
	  _createClass(hamstersjs, [{
	    ...
	    */
	    ...
	    value: function scheduleTask(task, resolve, reject) {
	      return this.pool.scheduleTask(task, this).then(function (results) {
	        resolve(results);
	    ...
	    */
	    ...
	    value: function hamstersPromise(params, functionToRun) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        return _this.scheduleTask(task, resolve, reject);
	      });
	    }
	  ...
	  _createClass(pool, [{
	    ...
	    */
	    ...
	    value: function runTask(hamster, index, task, scope, resolve, reject) {
	      ...
	      var array = scope.data.getSubArrayUsingIndex(task.params.array, index);
	    ...
	    */
	    ...
	    key: 'mergeOutputData',
	    value: function mergeOutputData(task, scope, threadId, results) {
